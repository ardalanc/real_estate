...
"ASK_PROPERTY_TITLE"  : "عنوان ملک را وارد کنید:",
"ASK_PROPERTY_PRICE"  : "قیمت ملک را وارد کنید (تومان):",
"ASK_PROPERTY_TYPE"   : "نوع ملک را انتخاب کنید:",
"ASK_PROPERTY_DESC"   : "توضیحات ملک را وارد کنید:",
"ASK_PROPERTY_PHOTO"  : "عکس ملک را ارسال کنید:",
"INVALID_TYPE"        : "❌ نوع ملک نامعتبر است. لطفاً یکی از گزینه‌ها را انتخاب کنید.",
